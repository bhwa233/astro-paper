...
Original contributions in this repository are licensed under the [PolyForm Noncommercial License 1.0.0](LICENSE), which does not permit commercial use. Portions derived from AstroPaper remain available under the MIT License; see [LICENSE](LICENSE) for attribution and the complete terms.
