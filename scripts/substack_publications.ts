...
const rawPublications = {
  ...
  commoncog: {
    key: "commoncog",
    kind: "rss",
    displayName: "Commoncog",
    author: "Cedric Chin",
    feedUrl: "https://commoncog.com/rss/",
    siteUrl: "https://commoncog.com/",
    feedHosts: ["commoncog.com", "www.commoncog.com"],
    articleHosts: ["commoncog.com", "www.commoncog.com"],
    imageHosts: ["commoncog.com", "www.commoncog.com"],
    tag: "Commoncog",
    priority: "medium",
    topics: ["商业判断", "运营管理", "专业能力", "决策方法", "资本配置"],
    selectionRule: "优先商业案例、运营经验与判断方法；排除会员销售公告",
    enabled: true,
    startAt: "2026-08-11",
    imagePolicy: "mirror",
    removeSelectors: [],
    excludeTitlePatterns: [
      {
        source: "(?:membership prices?|price increase)",
        flags: "i",
      },
    ],
  },
